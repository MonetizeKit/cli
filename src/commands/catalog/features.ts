...
export default class CatalogFeaturesCommand extends BaseCommand {
  static summary = "Manage feature catalog objects";
  ...
  async run(): Promise<void> {
    const { args, flags } = await this.parse(CatalogFeaturesCommand);
