...
export default class CatalogAddonsCommand extends BaseCommand {
  static summary = "Manage add-on catalog objects";
  ...
  async run(): Promise<void> {
    const { args, flags } = await this.parse(CatalogAddonsCommand);
