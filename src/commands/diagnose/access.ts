...
export default class DiagnoseAccessCommand extends BaseCommand {
  static summary = "Trace entitlement resolution for a customer feature";
  ...
  async run(): Promise<void> {
    const { args } = await this.parse(DiagnoseAccessCommand);
